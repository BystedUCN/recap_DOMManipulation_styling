...
document.querySelector(".oval").style.width = "40px";
document.querySelector(".oval").style.height = "40px";
document.querySelector(".oval").style.backgroundColor = "pink";
document.querySelector(".oval").style.borderRadius = "50%";
...
document.querySelector(".oval2").classList.add("niceStyling");